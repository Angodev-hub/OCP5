...
<div class="container tools">
    <div class="row">
        <div class="newpost">
            ...
            <form class="newpost" name="newpost" id="newpost" method="post" action="index.php?page=dashboard">
                <div class="form-group">
                    <label for="title">Titre de l'article :</label>
                    <input type="text" class="form-control" id="title" name="title" required="required">
                </div>
                <div class="form-group">
                    <label for="description">Brève description du contenu de l'article :</label>
